...
<div class="circle-back">
	...
	<div class="container">
	<?php
    $mypost = array( 'post_type' => 'congress', );
			...
			<div class="row">
				...
				<div class="col-lg-7 quote">
					...
					<div class="row mar-top grey-line">
						<div class="col-lg-4">
							<div class="about-tittle"><?php echo esc_html( get_post_meta( get_the_ID(), 'congress_price', true ) ); ?></div>
							<div class="description">Гривен стоит</div>
						</div>
						<div class="col-lg-4">
							<div class="about-tittle"><?php echo esc_html( get_post_meta( get_the_ID(), 'congress_data', true ) ); ?></div>
							<div class="description"><?php echo esc_html( get_post_meta( get_the_ID(), 'congress_time', true ) ); ?></div>
						</div>
						<div class="col-lg-4">
							<div class="about-tittle"><?php echo esc_html( get_post_meta( get_the_ID(), 'congress_place', true ) ); ?></div>
		...
		<div class="row">
			...
			<div class="col-lg-7 quote">
				...
				<div class="row plus-mar-left">
					<h3><strong><?php echo esc_html( get_post_meta( get_the_ID(), 'congress_author_name', true ) ); ?></strong></h3>
					<div class="person-position">
						<?php echo esc_html( get_post_meta( get_the_ID(), 'congress_author_position', true ) ); ?>
					</div>
					<div class="quote-text">
						<p>
						<?php echo esc_html( get_post_meta( get_the_ID(), 'congress_author_about', true ) ); ?></p>
					</div>
				</div>
			</div>
		</div>
